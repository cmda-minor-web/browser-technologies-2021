...
### Uitleg
Pas Progressive enhancement toe op je OBA Web App. Check je OBA Web App op de 8 features uit opdracht 1.1 en verbeter de code waar mogelijk. Test je OBAapp in het Device Lab. Laat je OBAapp voorlezen door een screenreader.
